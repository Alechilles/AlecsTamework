...
- While avatar flight is active, the lower-right ability HUD shows dedicated forward boost, upward flap, airbrake, and crouch-launch artwork while preserving Hytale's native ability frames and input labels.
