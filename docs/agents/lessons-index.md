...
The durable lesson notes live outside this repo at:

`C:\Users\22ale\AppData\Roaming\Hytale\My Mod Docs\Lessons Learned`

Agents should check these notes when a task matches the topic. Keep this index lightweight and update it when new durable lessons are added.

| Lesson file | Use when |
| --- | --- |
| `Assets-and-Load-Order.md` | Asset load order, manifest ordering, or generated patch precedence may explain behavior. |
| `Cat-Box-Block-Sets.md` | Cat box or block-set targeting behavior is involved. |
| `Debugging.md` | Logs, runtime symptoms, or source-vs-runtime mismatches need a diagnostic path. |
