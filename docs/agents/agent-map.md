...
| Needs, happiness, breeding, traits, progression | `wiki/Modder-Documentation/Config-Reference` | `src/main/java/com/alechilles/alecstamework/npc/progression`, relevant `Tw*Config` classes |
