...
| Replacement persistence kernel, import, operations, recovery, projections | `docs/decisions/0001-persistence-replacement-boundaries.md`, `docs/decisions/0007-persistence-core-implementation.md` | `src/main/java/com/alechilles/alecstamework/companion/{identity,lifecycle,snapshot}`, `src/main/java/com/alechilles/alecstamework/persistence/{kernel,migration,operation,projection,adapter/sqlite}`, `src/test/java/com/alechilles/alecstamework/persistence/{adapter/sqlite,architecture}` |
