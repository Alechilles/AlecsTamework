...
| Persistence, config overrides, saved state | `wiki/Developer-Documentation/Data-and-Persistence/Persistence-Sqlite-and-Data-Paths.md` | `src/main/java/com/alechilles/alecstamework/persistence`, `config/overrides` |
