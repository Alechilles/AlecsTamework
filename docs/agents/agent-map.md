...
| Runtime activation, dormancy, topology reload, activation diagnostics | `docs/Runtime-Activation.md` | `src/main/java/com/alechilles/alecstamework/runtime`, `src/test/java/com/alechilles/alecstamework/runtime` |
