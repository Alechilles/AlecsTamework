...
- Blocks acquisition when the player is at the per-player owned companion limit or the selected claim provider's target claim is at its companion limit, and shows a warning notification.
