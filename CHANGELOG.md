...
- Added a visible avatar-flight rider proxy attachment model with a dedicated flat texture and lower torso placement, replacing the raw player-model attachment while rider placement is being tuned.
