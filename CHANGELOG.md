...
- Fixed harvest cooldown setup so animals without progression modifiers still receive their configured cooldown instead of becoming harvestable again immediately.
