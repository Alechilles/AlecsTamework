...
### Fixed
- Rebuilt the avatar-flight launch particle sequence with custom brush-stroke wind sprites, rotating arcs, curved orbiting charge motes, helical launch streaks, upward mist, and radial ground dust, drawing from Hytale's battleaxe whirlwind and Wind Spirit effects.
