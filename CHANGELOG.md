...
### Fixed
- Fixed named linked companions reverting to their species name in the panel after their chunk unloaded. Ordinary unloaded rows now use the latest live state snapshot before falling back to older command-item metadata.
