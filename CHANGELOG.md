...
### Fixed
- Fixed persistence health diagnostics permanently reporting nine population evidence dimensions as unavailable after a clean startup scan. Durable owner, world, container, stored/live inventory, claim-occupancy, and loaded-projection coverage now publishes into the named health registry, while incomplete sources remain scoped and fail closed.
