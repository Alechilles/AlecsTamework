...
### Fixed
- Rebuilt avatar-flight launch spawners from clean, known-working base-game particle structures after the original authored payloads rendered blank in game, then restored the charge cue as a pale-cyan contracting ring with curved white-blue wind accents.
