...
- Fixed transformed avatar flight preserving leaked native sprint state, which could leave the dragon stuck in sprint/fast-flight animation after falling while holding sprint.
