...
- Fixed transformed avatar flight preserving leaked native sprint state, while still allowing real packet sprint input to play sprint animation in grounded transformed mode.
