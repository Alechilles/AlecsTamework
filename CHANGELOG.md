...
### Added
- Added a config-gated bonded companion `To Me` control that instantly mounts small companions on their owner's shoulder; role assets choose the attachment offset.
