...
### Fixed
- Fixed Recall being shown but rejected as unavailable after a released managed-coop companion's chunk unloaded. Deployed residents remain protected by their coop identity while participating in normal Recall relocation, and asynchronously loaded source/destination chunks remain retained until the pending relocation finishes or is canceled.
