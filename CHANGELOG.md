...
- Fixed beta mounted glide mounts to use Hytale's native mounted attachment and mounted input queue, so riders stay attached to the dragon while glide physics controls the mount.
