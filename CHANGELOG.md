...
### Fixed
- Fixed manual and passive breeding refusing to pair while startup population reconciliation was still scanning. Fresh pairs can now start immediately when the loaded breeding journal proves they have no incomplete birth, while only the exact parents of retained restart work remain blocked until duplicate-safe projection evidence is available.
