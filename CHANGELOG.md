...
- HUD popup delivery now routes through shared multi-HUD layers when available (for compatibility with HUD mods like EyeSpy) and no longer relies on repeated delayed reapply writes that could cause flicker.
