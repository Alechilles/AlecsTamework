...
- Added a dedicated lower-right avatar-flight control row for crouch launch, upward flap, forward boost, and airbrake, with complete frames, artwork, and input labels.
