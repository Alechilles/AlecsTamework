...
- Added avatar-flight rider attachment diagnostics under the existing debug flags to print the saved rider model and texture paths while testing model-anchor options.
