...
- Added a complete lower-right avatar-flight control row for crouch launch, upward flap, forward boost, and airbrake, with dedicated artwork, frames, and input labels while the tool-only Flightmaster's Talisman hides Hytale's native weapon ability strip.
