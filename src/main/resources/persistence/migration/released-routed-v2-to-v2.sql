ALTER TABLE schema_history RENAME TO schema_history_released_v2;
...
INSERT INTO schema_history(
    ...
    2, 'tamework-state', __APPLIED_AT_MS__, '__V2_SCHEMA_HASH__'
);

DROP TABLE schema_history_released_v2;
