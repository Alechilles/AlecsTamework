...
public record SpawnerCaptureMechanicsView(@Nonnull String configId,
    ...
    /** Source-compatible constructor for the original capture-policy API. */
    public SpawnerCaptureMechanicsView(String configId,
        ...
        this(configId, configRevision, sourceItemId, chanceMode, power,
                baseChance, chancePerPower, minimumChance, maximumChance,
    ...
    public SpawnerCaptureMechanicsView {
        ...
        if (successDisposition
            ...
            throw new IllegalArgumentException(
                    "TameAndCommandLink requires commandFamilyId."
            );
        }
