...
/** Passive per-session controller for a custom hotswap HUD renderer. */
public interface CommandHotswapHudController extends AutoCloseable {
    ...
    default void update(
            @Nonnull CommandHotswapHudUpdate update,
            @Nonnull UICommandBuilder commands
    ) {
    }
