...
import com.alechilles.alecstamework.npc.actions.BuilderActionTameworkForgetHostileTarget;
...
public final class TameworkNpcBuilderRegistrar {
    ...
    private void registerNpcActions(NPCPlugin npcPlugin) {
        ...
        if (actionFactory == null) {
            ...
            actionFactory.add(
                    BuilderActionTameworkForgetHostileTarget.BUILDER_ID,
                    BuilderActionTameworkForgetHostileTarget::new
            );
        ...
        if (sensorFactory == null) {
            ...
            sensorFactory.add(BuilderSensorTameworkFollowFormation.BUILDER_ID,
                    BuilderSensorTameworkFollowFormation::new);
            ...
            sensorFactory.add(BuilderSensorTameworkHasTalent.BUILDER_ID, BuilderSensorTameworkHasTalent::new);
