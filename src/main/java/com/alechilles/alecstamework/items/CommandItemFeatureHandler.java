...
public final class CommandItemFeatureHandler {
    ...
    /** Runs both detached command HUD composition paths against live registrations. */
    @Nonnull
    public CommandHudSelfTestResult runCommandHudSelfTest(
        ...
        SurfaceSelfTestResult target = runTargetHudSelfTest(
                resolver, ownerUuid, targetRendererId, targetId);
        SurfaceSelfTestResult hotswap = runHotswapHudSelfTest(
    ...
    @Nonnull
    private SurfaceSelfTestResult runTargetHudSelfTest(
    ...
    @Nonnull
    private SurfaceSelfTestResult runHotswapHudSelfTest(
            @Nonnull CommandHudCompositionResolver resolver,
            @Nonnull UUID ownerUuid,
            @Nonnull String rendererId,
            @Nonnull CommandHudContributorId contributorId
    ...
    private static boolean closeSession(@Nonnull CommandHudCompositionSession<?, ?, ?> session) {
        session.close();
