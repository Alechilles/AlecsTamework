...
public final class CommandItemFeatureHandler {
    ...
    private final CommandRespawnMenuService respawnMenuService;
    ...
    public CommandItemFeatureHandler(CommandItemRegistry registry,
        ...
        this.respawnMenuService = new CommandRespawnMenuService(
                deathService,
                lostService,
                linkMutationService,
                respawnService,
    ...
    private boolean openSelectionMenu(Player player,
        ...
        TameworkCommandSelectionPage page = new TameworkCommandSelectionPage(
                ...
                npcUuid -> respawnMenuService.respawn(player, toolId, npcUuid),
