...
/**
 * Toggles linked companion respawn trace diagnostics logging on the server.
 */
public final class TameworkDebugRespawnTraceCommand extends AbstractPlayerCommand {
