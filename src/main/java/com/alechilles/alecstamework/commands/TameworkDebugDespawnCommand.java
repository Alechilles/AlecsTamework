 ...
 */
public final class TameworkDebugDespawnCommand extends AbstractPlayerCommand {

    public TameworkDebugDespawnCommand() {
        super("debugdespawn", "Toggle Tamework companion despawn diagnostics logging.");
    ...
    protected void execute(@Nonnull CommandContext commandContext,
        ...
        boolean enabled = explicit != null
                ? plugin.setDebugDespawnEnabled(explicit)
                : plugin.toggleDebugDespawnEnabled();
