 ...
 */
public final class TameworkDebugNeedsDamageCommand extends AbstractPlayerCommand {

    public TameworkDebugNeedsDamageCommand() {
        super("debugneedsdamage", "Toggle Tamework needs damage diagnostics logging.");
