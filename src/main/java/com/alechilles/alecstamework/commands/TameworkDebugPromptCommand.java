 ...
 */
public final class TameworkDebugPromptCommand extends AbstractPlayerCommand {

    public TameworkDebugPromptCommand() {
        super("debugprompt", "Toggle Tamework interaction prompt debug logging.");
    ...
    protected void execute(@Nonnull CommandContext commandContext,
        ...
        commandContext.sender().sendMessage(Message.raw(
                "Tamework prompt debug logging: " + (enabled ? "enabled" : "disabled")
        ));
    }
