...
final class TameworkSettingsPageTextBinder {
    private static final String[][] TEXT_BINDINGS = {
            ...
            {"#TwSettingsAnnouncementsLabel", "tamework.ui.settings.label.announcements"},
            ...
            {"#TwSettingsAnimalProgressionSectionLabel", "tamework.ui.settings.label.animalProgression"},
            {"#TwSettingsNeedsTickPolicyModeLabel", "tamework.ui.settings.label.animalProgressionPolicy"},
            {"#TwSettingsNeedsOwnerOfflineGraceHoursLabel", "tamework.ui.settings.label.animalProgressionOfflineGraceHours"},
            {"#TwSettingsNeedsOwnerOfflineDecayMultiplierLabel", "tamework.ui.settings.label.animalProgressionOfflineMultiplier"},
            {"#TwSettingsAnimalAgingModeLabel", "tamework.ui.settings.label.animalAgingMode"},
            {"#TwSettingsAnimalOldAgeDeathLabel", "tamework.ui.settings.label.animalOldAgeDeath"},
    ...
    private static final String[][] TOOLTIP_BINDINGS = {
            ...
            {"#TwSettingsAnnouncementsTooltip", "tamework.ui.settings.tooltip.announcements"},
            ...
            {"#TwSettingsAnimalProgressionSectionTooltip", "tamework.ui.settings.tooltip.animalProgression"},
            {"#TwSettingsNeedsTickPolicyTooltip", "tamework.ui.settings.tooltip.animalProgressionPolicy"},
            {"#TwSettingsNeedsOfflineGraceTooltip", "tamework.ui.settings.tooltip.animalProgressionOfflineGraceHours"},
            {"#TwSettingsNeedsOfflineDecayMultiplierTooltip", "tamework.ui.settings.tooltip.animalProgressionOfflineMultiplier"},
            {"#TwSettingsAnimalAgingModeTooltip", "tamework.ui.settings.tooltip.animalAgingMode"},
            {"#TwSettingsAnimalOldAgeDeathTooltip", "tamework.ui.settings.tooltip.animalOldAgeDeath"},
    ...
    private static final String[][] NO_ITEMS_BINDINGS = {
            ...
            {"#TwSettingsAnimalAgingModeDropdown", "tamework.ui.settings.noItems.agingMode"},
