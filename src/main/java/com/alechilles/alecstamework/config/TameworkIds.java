...
public final class TameworkIds {
    ...
    public static final String ITEM_COMMAND_WHISTLE_EXAMPLE = "Tamework_Command_Whistle_Example";
    public static final String NPC_ROLE_TAMEWORK_EXAMPLE = "Mob_Tamework_Example";
    private TameworkIds() {
    }
}
