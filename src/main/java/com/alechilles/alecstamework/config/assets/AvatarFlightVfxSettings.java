...
public final class AvatarFlightVfxSettings {
    ...
    private static final double DEFAULT_CHARGE_MIN_SCALE = 0.85;
    private static final double DEFAULT_CHARGE_MAX_SCALE = 1.50;
    private static final double DEFAULT_CANCEL_SCALE = 1.0;
    private static final double DEFAULT_PARTIAL_SCALE = 1.20;
    private static final double DEFAULT_MID_SCALE = 1.60;
    private static final double DEFAULT_FULL_SCALE = 2.0;
