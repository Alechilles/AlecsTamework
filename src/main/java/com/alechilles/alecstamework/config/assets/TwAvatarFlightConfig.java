...
public final class TwAvatarFlightConfig implements
    ...
    private static final BuilderCodec<MovementSettings> MOVEMENT_CODEC =
            TwAvatarFlightMovementCodec.create();
    ...
    public static final class MovementSettings {
        ...
        public double getGroundedMoveSpeed() { return groundedMoveSpeed; }
