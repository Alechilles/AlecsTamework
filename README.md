...
- [Setup and Quick Start](https://wiki.hytalemodding.dev/mod/alecs-tamework/setup-and-quick-start)
- [Interaction Paths and Role Wiring](https://wiki.hytalemodding.dev/mod/alecs-tamework/interaction-paths-and-role-wiring)
- [Command System and Linked Panel Guide](https://wiki.hytalemodding.dev/mod/alecs-tamework/command-system-and-linked-panel-guide)
- [TwInteractionConfig Reference](https://wiki.hytalemodding.dev/mod/alecs-tamework/twinteractionconfig-reference)
