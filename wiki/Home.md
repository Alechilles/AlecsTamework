...
draft: false
---
# Alec's Tamework Wiki

Alec's Tamework is a framework mod for Hytale. It gives modders reusable systems for taming, ownership, capture and spawn items, command tools, linked companion UI, progression systems, coops, and related NPC behavior.

Tamework does not add a full gameplay expansion by itself. Players usually experience it through other mods that depend on it, while modders and developers use it as the underlying framework.

## 1) Player Guides
- [Player Guides](/mod/alecs-tamework/player-guides)
...
- [Start Here](/mod/alecs-tamework/start-here)
- [Public API](/mod/alecs-tamework/public-api)
- [API Reference](/mod/alecs-tamework/api-reference)
- [API Recipes](/mod/alecs-tamework/api-recipes)
- [System Integration](/mod/alecs-tamework/system-integration)
...
- [Core Architecture](/mod/alecs-tamework/core-architecture)
- [Runtime Subsystems](/mod/alecs-tamework/runtime-subsystems)
- [Data and Persistence](/mod/alecs-tamework/data-and-persistence)
- [Tooling and Contribution](/mod/alecs-tamework/tooling-and-contribution)
