...
When an ambiguity is bounded to one historical owner-population journal and profile, startup first commits durable v7 fences for both exact scopes. The journal stays nonterminal and the affected companion remains unavailable, but conflict-free evidence can restore owner and claim readiness for unrelated profiles immediately. Bootstrap recognizes containment only while both fences are active; a missing or failed fence keeps the broader authority fail-closed. Diagnostic operation counts continue to include the retained journal.
