...
This creates one isolated Patchwork run, verifies expected JSON pointers, and cleans that exact run without modifying the production generated pack. Patchwork 1.3.3 truthfully reports a successful self-test as restart-required because it validates generation rather than live Hytale activation.
