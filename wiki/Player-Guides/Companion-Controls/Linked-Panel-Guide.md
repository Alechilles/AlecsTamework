...
- Generic linked panels include a `Highlight Active` setting. It starts off.
  When enabled, loaded active companions show sparkles while you hold that
  command tool. Only you see the sparkles. Their color matches each companion's
  group; ungrouped companions use neutral gold.
